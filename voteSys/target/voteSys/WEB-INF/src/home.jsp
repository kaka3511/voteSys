...
<div>
    ...
    <ul class="nav navbar-nav navbar-right">
        <li><span class="glyphicon glyphicon-user"></span> 游客</li>
        <li><a href="${pageContext.request.contextPath }/user/register.do"><span class="glyphicon glyphicon-user"></span> 注册</a></li>
        <li><a href="${pageContext.request.contextPath }/user/login.do"><span class="glyphicon glyphicon-log-in"></span> 登录</a></li>
        <li><a href="${pageContext.request.contextPath }/user/loginAdmin.do"><span class="glyphicon glyphicon-log-in"></span> 管理员登录</a></li>
    </ul>
</div>
