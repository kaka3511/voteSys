...
<body>
<form action="${pageContext.request.contextPath }/user/modifyUserDo.do" method="post" accept-charset="utf-8">
    <center>
        <div class="input-group input-group-lg">
            <span class="input-group-addon">用户名</span>
            <input name="username"
                   type="text" class="form-control" placeholder="${user.username}" ">
            <br>
        </div>
        <div class="input-group input-group-lg">
