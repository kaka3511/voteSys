...
<head>
    ...
    <script type="text/javascript">
        function goPublic(){
            ...
            userManage.setAttribute("class", "active1");
            var publicManage = document.getElementById('publicManage');
            publicManage.setAttribute("class", "active1");
            var messageManage = document.getElementById('messageManage');
            messageManage.setAttribute("class", "active1");
            var voteManage = document.getElementById('voteManage');
            voteManage.setAttribute("class", "active1");
        }
        function goMessage(){
        ...
        function goUserManage(){
            document.getElementById("iframeID").src="${pageContext.request.contextPath }/user/list.do";
            var publicEle = document.getElementById('public');
            publicEle.setAttribute("class", "active1");
            var message = document.getElementById('message');
            message.setAttribute("class", "active1");
            ...
            vote.setAttribute("class", "active1");
            var userManage = document.getElementById('userManage');
            userManage.setAttribute("class", "active");
            var publicManage = document.getElementById('publicManage');
            publicManage.setAttribute("class", "active1");
            var messageManage = document.getElementById('messageManage');
            messageManage.setAttribute("class", "active1");
        ...
        function goPublicManage(){
            document.getElementById("iframeID").src="${pageContext.request.contextPath }/notice/list.do";
            var publicEle = document.getElementById('public');
            publicEle.setAttribute("class", "active1");
            var message = document.getElementById('message');
            message.setAttribute("class", "active1");
            ...
            userManage.setAttribute("class", "active1");
            var publicManage = document.getElementById('publicManage');
            publicManage.setAttribute("class", "active");
            var messageManage = document.getElementById('messageManage');
            messageManage.setAttribute("class", "active1");
            var voteManage = document.getElementById('voteManage');
            voteManage.setAttribute("class", "active1");
        }
        function goMessageManage(){
            document.getElementById("iframeID").src="${pageContext.request.contextPath }/message/list.do";
            var publicEle = document.getElementById('public');
            publicEle.setAttribute("class", "active1");
            var message = document.getElementById('message');
            message.setAttribute("class", "active1");
            ...
            publicManage.setAttribute("class", "active1");
            var messageManage = document.getElementById('messageManage');
            messageManage.setAttribute("class", "active");
            var voteManage = document.getElementById('voteManage');
            voteManage.setAttribute("class", "active1");
        }
        function goVoteManage(){
            document.getElementById("iframeID").src="${pageContext.request.contextPath }/vote/list.do";
            var publicEle = document.getElementById('public');
            publicEle.setAttribute("class", "active1");
            var message = document.getElementById('message');
            message.setAttribute("class", "active1");
            ...
            messageManage.setAttribute("class", "active1");
            var voteManage = document.getElementById('voteManage');
            voteManage.setAttribute("class", "active");
        }
    </script>
    <style type="text/css">
        body{
        ...
        <nav class="navbar navbar-default" role="navigation">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav ">
                    ...
                    <li id="userManage">
                        <a href="#" onclick="goUserManage()">用户管理</a>
                    </li>
                    <li id="publicManage">
                        <a href="#" onclick="goPublicManage()">系统公告管理</a>
                    </li>
                    <li id="messageManage">
                        <a href="#" onclick="goMessageManage()">留言管理</a>
                    </li>
                    <li id="voteManage">
                        <a href="#" onclick="goVoteManage()">投票管理</a>
                    </li>
                </ul>
            </div>
